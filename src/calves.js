...
const layout = `
        ...
        <div class="text-right mt-3">
            <button class="cursor-pointer bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded mr-2 mb-3 fixed bottom-5 right-32 z-50 shadow-lg transition-colors" id="btn-add-calf">
                Yeni Hayvan Ekle
