...
addButton.addEventListener("click", () => {
    ...
    if (type.value === "cow") {
        ...
        newAnimalDatas.cowDatas.InseminationDate = inseminationDateInput.value || null;
        newAnimalDatas.cowDatas.BullName = bullNameInput.value;
        newAnimalDatas.cowDatas.CheckedDate = checkInput.value || null;
        ...
        console.log(lastBirthDate.value)
        newAnimalDatas.heiferDatas.LastBirthDate = lastBirthDate.value || null;
        ...
        newAnimalDatas.calfDatas.BirthDate = birthDate.value || null;
