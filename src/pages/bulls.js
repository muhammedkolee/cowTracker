...
const layout = `
        ...
        <div class="text-right mt-3">
            <button title="Yeni Hayvan Ekleme sayfasına yönlendirir" class="cursor-pointer bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded mr-2 mb-3 fixed bottom-5 right-32 z-50 shadow-lg transition-colors" id="btn-add-bull">
                Yeni Hayvan Ekle
...
function setupEventListeners(allDatas) {
    ...
    bullTableBody.addEventListener("click", async function (event) {
...
function renderTableOnly(currentAnimalsData) {
    ...
    currentAnimalsData.forEach((bull) => {
        ...
        tableRow.className = "even:bg-blue-500 odd:bg-cyan-500 hover:bg-green-400 transition-colors";
        age.textContent =
