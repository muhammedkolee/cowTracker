        ...
        row.innerHTML = `
            ...
            <td class="px-4 py-3 text-center border-b">
                <div class="flex justify-center gap-2">
                    <button onclick="restoreAnimal(${animal.Id})" title="Geri Yükle" class="bg-green-500 hover:cursor-pointer hover:bg-green-600 text-white p-2 rounded transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" />
                        </svg>
                    </button>
                    <button onclick="hardDeleteAnimal(${animal.Id})" title="Kalıcı Olarak Sil" class="bg-red-600 hover:cursor-pointer hover:bg-red-700 text-white p-2 rounded transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
