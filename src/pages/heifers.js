...
function renderTableOnly(currentAnimalsData) {
    ...
    currentAnimalsData.forEach((heifer) => {
        ...
        tableRow.dataset.heiferId = heifer.Id;
        ...
        lastBirth.textContent = heifer.LastBirthDate != null ? new Date(heifer.LastBirthDate).toLocaleDateString("tr-TR") : "-" 
        // new Date(
        //     heifer.LastBirthDate
        // ).toLocaleDateString("tr-TR");
        tempDays.textContent = heifer.LastBirthDate != null ? calculateDate(heifer.LastBirthDate) : "-";
