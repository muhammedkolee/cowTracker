...
function updateMotherName() {
    ...
    // Find the animal who is selected
...
// If animal type changes, update field
...
updateButton.addEventListener("click", async (e) => {
    ...
    allDatas.online = navigator.onLine;
    // Receive response from ipcMain and show.
    const response = await window.updateAPI.updateAnimalDatas(allDatas);
    console.log("updateAnimal.js: ", response)
