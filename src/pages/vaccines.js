...
function showDatas(allDatas) {
    ...
    Object.values(animalVaccineMap).forEach((animal) => {
        ...
        tableRow.className = "hover:bg-blue-300 transition-colors duration-150 font-bold odd:bg-orange-300 even:bg-yellow-300";
        ...
        vaccineNames.forEach(vaccineName => {
            ...
            if (animal.vaccines[vaccineName] && animal.vaccines[vaccineName].length > 0) {
                ...
                animal.vaccines[vaccineName].forEach(vaccine => {
                    ...
                    deleteBtn.className = "delete-vaccine-btn text-red-500 hover:text-red-700 cursor-pointer transition-colors";
